              ...
              <img src={image}
                ...
                <div className='absolute inset-0 flex justify-end m-3 card-img_hover'>
                  <div
                    ...
                    className='black-gradient rounded-full flex justify-center 
                    w-10 h-10 items-center cursor-pointer' >
                      <img
                      src={github}
                      alt="github"
        ...
        <div className='w-full flex'>
          <motion.p
            ...
            max-w-3xl leading-[30px]'>
              ...
              through real-world examples of my work. Each project is breifly described with 
